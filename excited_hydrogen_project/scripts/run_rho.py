...
from hydrogen_sim.config import *  # <-- ADJUST
from hydrogen_sim.basis import make_hydrogen_basis  # <-- ADJUST
from hydrogen_sim.operators import Operators  # <-- ADJUST
...
def build_config() -> SimulationConfig:
    ...
    """
    return SimulationConfig(BasisConfig(),PulseConfig(E0=0.0),TimeGridConfig(),RelaxationConfig())
